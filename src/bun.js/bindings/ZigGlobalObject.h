...
public:
    ...
    Structure* JSSQLDatabaseStructure() const { return m_JSSQLDatabaseStructure.getInitializedOnMainThread(this); }
...
public:
    ...
    LazyProperty<JSGlobalObject, Structure> m_JSSQLDatabaseStructure;
